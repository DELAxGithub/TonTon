...
interface YesterdayBalanceProps {
  data: {
    intake: number;
    burned: number;
    net: number;
...
export const YesterdayBalance: React.FC<YesterdayBalanceProps> = ({ data }) => {
  const progressPercent = Math.abs(data.net) / 2000; // 2000kcalを最大値と仮定

  return (
    <View style={styles.container}>
      <Text style={styles.title}>前日の確定収支</Text>
...
export default YesterdayBalance; 